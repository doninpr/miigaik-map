...
class Info extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <p>Проект находится в режиме beta-тестирования. Если вы обнаружили недоработки или у вас есть идеи и пожелания, то напишите нам об этом по адресу datamap@miigaik.ru.</p>
